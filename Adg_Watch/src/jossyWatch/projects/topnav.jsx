...
const Topnav = () => {
    return (
        <>
            <div className="bg-slate-200 w-full h-[5rem] flex items-center justify-evenly text-black">
                ...
                <div className="w-[10%] h-full border white-black flex justify-center items-center">
                    <div className="w-[30%] items-center flex justify-center">
                        ...
                        <h3 className="text-2xl text-black font-sans uppercase font-bold cursor-pointer">adg</h3>
                    </div>
                </div>
